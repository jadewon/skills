...
# Deterministic parts (time math, session lookup, cache I/O) live here so the SKILL.md
...
#
# Scheduling, listing and cancelling all go through the slack MCP server
# (mcp__slack__slack_api); this helper only covers what a tool call cannot do.
