...
AI agent가 이슈 단위 작업을 넘어 스스로 제품을 개선하려면, 제품에 대한 정보가 잘 정리되어 있어야 합니다. 정보가 없으면 agent는 의미 있는 판단을 내릴 수 없습니다.

이 스킬은 모두가 동일한 형식으로 쉽게 문서를 작성할 수 있도록 도와줍니다. 템플릿 기반, 중앙 관리, 자동 PR까지 한번에 처리합니다.
